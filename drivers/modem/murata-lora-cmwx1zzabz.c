...
#if !defined(CONFIG_MODEM_MURATA_LORA_CMWX1ZZABZ_MANUAL_MCCMNO)
#define CONFIG_MODEM_MURATA_LORA_CMWX1ZZABZ_MANUAL_MCCMNO ""
#endif
...
enum mdm_control_pins {
	MDM_POWER = 0,
	MDM_RESET,
#if defined(DT_MURATA_LORA_CMWX1ZZABZ_0_MDM_VINT_GPIOS_CONTROLLER)
	MDM_VINT,
#endif
};
...
static struct modem_pin modem_pins[] = {
	/* MDM_POWER */
	MODEM_PIN(DT_INST_0_MURATA_LORA_CMWX1ZZABZ_MDM_POWER_GPIOS_CONTROLLER,
		  DT_INST_0_MURATA_LORA_CMWX1ZZABZ_MDM_POWER_GPIOS_PIN, GPIO_DIR_OUT),

	/* MDM_RESET */
	MODEM_PIN(DT_INST_0_MURATA_LORA_CMWX1ZZABZ_MDM_RESET_GPIOS_CONTROLLER,
		  DT_INST_0_MURATA_LORA_CMWX1ZZABZ_MDM_RESET_GPIOS_PIN, GPIO_DIR_OUT),

#if defined(DT_MURATA_LORA_CMWX1ZZABZ_0_MDM_VINT_GPIOS_CONTROLLER)
	/* MDM_VINT */
	MODEM_PIN(DT_INST_0_MURATA_LORA_CMWX1ZZABZ_MDM_VINT_GPIOS_CONTROLLER,
		  DT_INST_0_MURATA_LORA_CMWX1ZZABZ_MDM_VINT_GPIOS_PIN, GPIO_DIR_IN),
#endif
};

#define MDM_UART_DEV_NAME		DT_INST_0_MURATA_LORA_CMWX1ZZABZ_BUS_NAME
...
K_THREAD_STACK_DEFINE(modem_rx_stack,
		      CONFIG_MODEM_MURATA_LORA_CMWX1ZZABZ_RX_STACK_SIZE);
struct k_thread modem_rx_thread;

/* RX thread work queue */
K_THREAD_STACK_DEFINE(modem_workq_stack,
		      CONFIG_MODEM_MURATA_LORA_CMWX1ZZABZ_RX_WORKQ_STACK_SIZE);
...
static void modem_reset(void)
{
	...
	static struct setup_cmd setup_cmds[] = {
		...
		SETUP_CMD_NOHANDLE("AT+CGDCONT=1,\"IP\",\""
					CONFIG_MODEM_MURATA_LORA_CMWX1ZZABZ_APN "\""),
		/* start functionality */
		SETUP_CMD_NOHANDLE("AT+CFUN=1"),
	};

	static struct setup_cmd setup_cmds_2[] = {
		/* set the APN */
		SETUP_CMD_NOHANDLE("AT+UPSD=0,1,\""
				CONFIG_MODEM_MURATA_LORA_CMWX1ZZABZ_MANUAL_MCCMNO "\""),
		/* set dynamic IP */
...
restart:
	...
	if (strlen(CONFIG_MODEM_MURATA_LORA_CMWX1ZZABZ_MANUAL_MCCMNO) > 0) {
