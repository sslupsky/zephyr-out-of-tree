...
#define SPI_NAND_ERASE_TIMEOUT		14000	/* erase time out (us)   */
#define SPI_NAND_PROG_TIMEOUT		1200	/* program time out (us) */
#define SPI_NAND_READ_TIMEOUT		560	/* read time out (us) */
#define SPI_NAND_RESET_TIMEOUT		20000	/* reset time out */
